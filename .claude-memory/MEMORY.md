...
- [Perfil del usuario](user_profile.md) — dev con <6 meses en Angular/Node/Postgres, background en Oracle APEX, Python, VBA, C, Clipper
- [Entorno PC](project_environment.md) — Windows 10 LTSC, sin WSL, sin Docker/Hyper-V; stack instalado y versiones
- [Mecánicas del juego](project_botellas_game_mechanics.md) — reglas completas del water sort puzzle: botellas normales, especial, bloqueadas, colores ocultos
